...
public class ModItems
{
    ...
    // Armor
    public static final RegistryObject<Item> BLACK_HELMET       = ITEMS.register("black_helmet",    getArmorSupplier(ArmorMaterials.IRON, EquipmentSlot.HEAD));
    public static final RegistryObject<Item> BLACK_CHESTPLATE   = ITEMS.register("black_chestplate",getArmorSupplier(ArmorMaterials.IRON, EquipmentSlot.CHEST));
    public static final RegistryObject<Item> BLACK_LEGGINGS     = ITEMS.register("black_leggings",  getArmorSupplier(ArmorMaterials.IRON, EquipmentSlot.LEGS));
    public static final RegistryObject<Item> BLACK_BOOTS        = ITEMS.register("black_boots",     getArmorSupplier(ArmorMaterials.IRON, EquipmentSlot.FEET));

    public static final RegistryObject<Item> MITHRIL_HELMET     = ITEMS.register("mithril_helmet",  getArmorSupplier(ArmorMaterials.DIAMOND, EquipmentSlot.HEAD));
    public static final RegistryObject<Item> MITHRIL_CHESTPLATE = ITEMS.register("mithril_chestplate",getArmorSupplier(ArmorMaterials.DIAMOND, EquipmentSlot.CHEST));
    public static final RegistryObject<Item> MITHRIL_LEGGINGS   = ITEMS.register("mithril_leggings",getArmorSupplier(ArmorMaterials.DIAMOND, EquipmentSlot.LEGS));
    public static final RegistryObject<Item> MITHRIL_BOOTS      = ITEMS.register("mithril_boots",   getArmorSupplier(ArmorMaterials.DIAMOND, EquipmentSlot.FEET));
    ...
    public static Supplier<? extends Item> getArmorSupplier(@Nonnull ArmorMaterial tier, EquipmentSlot type)
    {
